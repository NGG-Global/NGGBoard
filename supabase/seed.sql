...
--   '{"allow_text":true,"allow_image":true,"name_policy":"optional","anonymous_allowed":true,"multiple_submissions":true,"text_char_limit":280,"image_size_limit_mb":8,"allow_participant_edit":false,"allow_participant_delete":true}'::jsonb,
